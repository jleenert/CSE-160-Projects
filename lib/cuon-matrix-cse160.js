...
class Vector3 {
    ...
    add(other) {
        ...
        self = this.elements;
        let adder = other.elements;
        for (let i = 0; i < 3; ++i) {
          self[i] = self[i] + adder[i];
        }
    ...
    sub(other) {
        ...
        self = this.elements;
        let subber = other.elements;
        for (let i = 0; i < 3; ++i) {
          self[i] = self[i] - subber[i];
        }
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] = (vec1[1] * vec2[2]) - (vec2[1] * vec1[2]);
        v3.elements[1] = 0 - ((vec1[0] * vec2[2]) - (vec2[0] * vec1[2]));
        v3.elements[2] = (vec1[0] * vec2[1]) - (vec2[0] * vec1[1]);
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        ...
        let m = (vec[0] * vec[0]) + (vec[1] * vec[1]) + (vec[2] * vec[2]);
        m = Math.sqrt(m);
    ...
    normalize() {
        ...
        let divisor = (vec[0] * vec[0]) + (vec[1] * vec[1]) + (vec[2] * vec[2]);
